...
const UpdateProduct = () => {
  ...
  const validateForm = () => {
    if (!name || !price) {
      toast.error("Name and Price are required.", { autoClose: 2000 });
      return false;
    }
    return true;
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      console.log("Delete response:", response); // Check API response
      ...
      <div className="bg-gradient-to-r from-blue-700 to-purple-800 p-6 rounded-lg shadow-lg">
        ...
        <div className="flex mb-3">
          ...
          <div className="space-y-6">
            <div>
              <label htmlFor="name" className="block text-gray-200 mb-2">Product Name</label>
              <input
                type="text"
                id="name"
            ...
            <div>
              <label htmlFor="price" className="block text-gray-200 mb-2">Price (DH)</label>
              <input
                type="number"
                id="price"
                min="0"
            ...
            <div>
              <label htmlFor="priceSale" className="block text-gray-200 mb-2">Price Sale (optional)</label>
              <input
                type="number"
                id="priceSale"
                min="0"
